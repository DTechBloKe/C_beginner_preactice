...
*It also shows how to use perenthesis operators to escape Precedences
*/
...
int main()
{
	...
	float averageGrade, gradeDeltal, percentDiff;
	...
	gradeDeltal = 95 - averageGrade;
	percentDiff = 100 * ((95 - averageGrade)/95);
	printf("Your grade is %.1f points lower than the ", gradeDeltal);
